...
ActiveRecord::Schema.define(version: 20151208063053) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.float    "weight_goal_lbs"
    t.float    "weight_starting_lbs"
  ...
  create_table "weight_loss_models", force: :cascade do |t|
